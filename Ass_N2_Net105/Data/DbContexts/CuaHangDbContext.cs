...
namespace Data.DbContexts
{
    public class CuaHangDbContext : DbContext
    {
        ...
        {
            base.OnConfiguring(optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-OJ4UDNH\SQLEXPRESS;Initial Catalog=CuaHangAo;Persist Security Info=True;User ID=Nbton03;Password=123"));
        }
